...
def fill_data():
    ...
    disciplines = ['High mathematics', 'Chemistry', 'Economy', 'Mechatronics', 'History of Ukraine',
                   'Theoretical mechanics', 'Theory of control automation', 'Microelectronics']

    groups = ['EM10', 'EE12', 'BT01']
